...
def lenght_operation(value, operation, lenght_operations): # операции по конвертации длины
    answer = value * (float (lenght_operations[operation]))
    return answer

def temperature_operation(value, operation, temperature_operations): # опреации по конвертации температур
...
def pressure_operation(value, operation, pressure_operations): # операции по конвертации давления
    pass
...
def converter(): # Выбор способа конвертации
    ...
    elif operation.lower() in pressure_operations:
        print (pressure_operation(value, operation, pressure_operations))
converter()
